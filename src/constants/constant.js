...
//     // -----------------------------
//     COLORS: {
//         PRIMARY: process.env.COLOR_PRIMARY || "#1D4ED8",       // blue-700
//         SECONDARY: process.env.COLOR_SECONDARY || "#F59E0B",   // amber-500
//         SUCCESS: process.env.COLOR_SUCCESS || "#10B981",       // green-500
//         DANGER: process.env.COLOR_DANGER || "#EF4444",         // red-500
//         WARNING: process.env.COLOR_WARNING || "#FBBF24",       // yellow-400
//         INFO: process.env.COLOR_INFO || "#3B82F6",             // blue-500
//         LIGHT: process.env.COLOR_LIGHT || "#F3F4F6",           // gray-100
//         DARK: process.env.COLOR_DARK || "#111827",             // gray-900
//     },
